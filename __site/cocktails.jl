...
# ╔═╡ 8d26386d-33f6-4a57-91b9-221329fc0e91
...
prob = ODEProblem(simpsys, [V=>V₀, S=>S₀, I=>0.20, T=>20], (0.0, 20.0))
...
plot(solution, vars=[I, V, Z])

# ╔═╡ f2ca523f-5153-4e56-97a5-e09881d6800b
plot(solution, vars=[T, S])
