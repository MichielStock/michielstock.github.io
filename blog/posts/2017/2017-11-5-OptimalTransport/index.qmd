...
description: "Accessible intro to optimal transportation theory, with applications in machine learning and image processing."
aliases:
  - "/posts/2017/OptimalTransport/"
freeze: true
---
...
![Quantities of every dessert.](desserts.png)
...
![Number of pieces every KERMIT number can take.](staff.png)
...
![Preferences of the KERMIT staff for different desserts.](preferences.png)
...
![The solution of the dessert problem with $\lambda=10$, an excellent approximation of the unregularized problem.](desserts_high_lambda.png)
...
![The solution with a slightly lower $\lambda$. Clearly, a different optimal distribution is obtained.](desserts_low_lambda.png)
...
![A geometric view of the optimal transport problem.](geometry.png)
...
![Every point of the first set is matched with the corresponding points of the second set.](connect_sets.png)
...
![A training set with three discrete labels and an unlabeled test set with a shifted distribution.](domain_adaptation.png)
...
Levy, B. and Schwindt, E. (2017). *Notions of optimal transport theory and how to implement them on a computer*.  [arxiv](https://arxiv.org/abs/1710.02634)
