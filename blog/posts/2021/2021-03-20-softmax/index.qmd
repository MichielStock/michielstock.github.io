...
date: 2021-03-20
categories: [code, maths, datascience]
aliases:
  - "/posts/2021/2021-03-20-softmax/"
freeze: true
---
...
Or, we can use the same trick to approximate a one-hot-vector $\mathbf{y}$:
...
![Samples of an optimal coloring. Funky.](entropic_totoro.gif)
...
[^maxlse]: This rearrangement of the log-exp-sum function makes it obvious that it is bounded between the maximum and the maximum plus a logarithmic bound depending on the number of elements.
