...
![Don't at me like that python! Julia just gets me! It is more than a performance thing!](julia.svg)
...
![Kernel smoothing of a noisy signal.](output_51_0.png)
...
![Heatmap of matrix A.](output_56_0.png)
...
![Gradient in x direction.](output_58_0.png)
...
![Gradient in y direction.](output_60_0.png)
...
![Cameraman test image.](output_62_0.png)

```julia
heatmap(image_grad_x(img))
```

![Cameraman gradient in x direction.](output_63_0.png)

```julia
heatmap(image_grad_y(img))
```

![Cameraman gradient in y direction.](output_64_0.png)
...
![Random initial state for Game of Life.](output_67_0.png)
...
![Game of Life after one step.](output_68_1.png)
...
![Game of Life after 1000 steps.](output_70_0.png)
...
![Slice of the 3D diffusion simulation.](output_78_0.png)
...
![Signal with uncertainty bounds.](output_81_0.png)
...
![Processed signal with uncertainty bounds.](output_84_0.png)
