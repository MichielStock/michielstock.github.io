...
date: 2020-06-17
description: "My take on the best books on productivity."
aliases:
  - "/posts/2020/advice-on-being-effective/"
freeze: true
---
...
At some point in their lives, everyone will advance to the point where one has more on their plate than they can handle. When organizing your tasks, look at both the urgency and the importance.

![Time management matrix as proposed by Stephen Covey, image from Huffpost.](timemanagement.png)
...
![The main types of items in rapid logging. Note that rapid logging matches splendidly with dotted paper.](rapidlogging.jpg)
