...
date: 2018-03-07
categories: [maths, datascience]
aliases:
  - "/posts/2018/ConvexSummary/"
freeze: true
---
...
A *convex function* $f$ is a function for which the input domain is convex and for which it holds that
...
![A convex function.](convex_function_illustration.png)
...
![Descent and ascent step.](descent_step.png)
...
![Path of gradient descent on the quadratic and non-quadratic functions.](gradient_descent.png)
![Convergence of gradient descent on the quadratic and non-quadratic functions.](convergence_gd.png)
...
Dealing with inequality constraints is more complex. In general, we want to solve
...
![Larger values of $t$ result in a better approximation.](log_bar.png)
